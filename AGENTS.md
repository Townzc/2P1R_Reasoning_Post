...
- First-session GPU process runtime budget: 7200 seconds, explicitly approved by the user. Preserve its historical ledger and enforce per-job bounds. E015 remains within this allowance: 6467 seconds used, 733 remaining, one 360-second process plus 15-second guard. This balance is not a permanent financial limit on later scientifically approved phases; record any later phase-specific process authorization without resetting historical receipts. No paid APIs or extra machines are authorized.
